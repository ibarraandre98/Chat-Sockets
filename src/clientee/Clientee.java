...
public class Clientee extends javax.swing.JFrame {
    ...
    private void NServidorActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void fondooActionPerformed(java.awt.event.ActionEvent evt) {
        JFileChooser fc = new JFileChooser();
        FileNameExtensionFilter fil = new FileNameExtensionFilter("JPG", "jpg", "png");
        fc.setFileFilter(fil);
        fc.setMultiSelectionEnabled(false);
